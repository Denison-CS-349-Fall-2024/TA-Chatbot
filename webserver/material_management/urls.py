...
# URL patterns for the material management app
urlpatterns = [
    ...
    path('get-materials-by-class-id/<str:semester>/<str:classId>/', views.get_materials_by_class_id, name='get_materials_by_class_id'),
]